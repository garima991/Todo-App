    ...
    <div className="flex flex-col justify-center items-center rounded-xl h-screen w-screen">
      ...
      >
        <div className="w-full rounded-lg flex flex-col overflow-hidden">
          ...
          <input
            className=" px-4 pb-2 text-sm outline-none focus:ring-1 focus:ring-slate-200"
            type="text"
        ...
        <button
          type="submit"
          className="bg-white p-2 hover:bg-lime-300 outline focus:ring-2 focus:ring-black rounded-xl"
          aria-label="Add Task"
        >
